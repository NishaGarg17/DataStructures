...
public class QueueUsingStacksUtility1 {
	public static void main(String[] args) {
		System.out.println("Welcome to QueueUsingStacks Program");
		Scanner sc = new Scanner(System.in);
		QueueUsingStacks1 queueUsingStacks = new QueueUsingStacks1();
	...
	private static void getInput(QueueUsingStacks1 queueUsingStacks) {
		Scanner sc = new Scanner(System.in);
		int index, data;
